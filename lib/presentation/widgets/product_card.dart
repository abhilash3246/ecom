...
class OpenFlutterProductCard extends StatelessWidget {
  ...
  Widget buildColor(Product product, ThemeData _theme) {
    return Row(
      children: <Widget>[
        Text('Color:', style: _theme.textTheme.body2.copyWith()),
        Padding(
          padding: EdgeInsets.only(left: AppSizes.linePadding),
        ),
        Text('Blue',
            style: _theme.textTheme.body2.copyWith(color: AppColors.black))
      ],
    );
  }
  ...
  Row buildSize(Product product, ThemeData _theme) {
    return Row(
      children: <Widget>[
        Text('Size:', style: _theme.textTheme.body2.copyWith()),
        Padding(
          padding: EdgeInsets.only(left: AppSizes.linePadding),
        ),
        Text('L',
