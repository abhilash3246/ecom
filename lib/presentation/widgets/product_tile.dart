...
import 'package:ecom/presentation/features/product_details/product_screen.dart';
...
class OpenFlutterProductTile extends StatelessWidget {
  ...
  Widget buildTitleAndSubtitle(ThemeData _theme) {
    return showCategoryFirst
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text(product.categoryTitle, style: _theme.textTheme.body2),
        Text(product.title, style: _theme.textTheme.display2),
      ],
    )
        : Column(
      mainAxisAlignment: MainAxisAlignment.start,
  ...
  Widget buildColor(Product product, ThemeData _theme) {
    return Row(
      children: <Widget>[
        Text('Color:', style: _theme.textTheme.headline.copyWith()),
        Padding(
          padding: EdgeInsets.only(left: AppSizes.linePadding),
        ),
        Text(
          'Blue',
          style: _theme.textTheme.headline.copyWith(color: AppColors.black),
        ),
      ],
    );
  }
  ...
  Widget buildSize(Product product, ThemeData _theme) {
    return Row(
      children: <Widget>[
        Text('Size:', style: _theme.textTheme.headline.copyWith()),
        Padding(
          padding: EdgeInsets.only(left: AppSizes.linePadding),
        ),
        Text('L',
